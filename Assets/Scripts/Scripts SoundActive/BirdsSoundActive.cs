...
public class BirdsSoundActive : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            AudioManager.Instance.Play2D("6"); // Se usa 2D para que el sonido no cambie por la posicion en donde este la camara
